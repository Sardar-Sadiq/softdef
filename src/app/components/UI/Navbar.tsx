      ...
      <div className="flex mt-6 w-full items-center justify-between mx-auto px-4 sm:px-8 lg:px-10 py-6 md:py-8 bg-transparent text-white">
        ...
        <nav className="hidden lg:flex grow justify-center pt-3 ">
          <div className="flex grow justify-between items-center px-8">
            <ul className="flex items-center gap-10 text-2xl font-normal indie mx-auto">
              {menuItems.map((item) => (
        ...
        <div className="  flex flex-col items-start pt-2 ">
            <a href="#">
              <div className="  h-0 border-t-4 border-white rounded-sm transition-all duration-300 ease-in-out w-[1.938rem] mb-2" />

            <div className="h-0 border-t-4 border-white rounded-sm transition-opacity duration-300 ease-in-out w-[1.438rem]" />
              </a>
